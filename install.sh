...
cp sky130_fd_pr_reram/cells/reram_cell/sky130_fd_pr_reram__reram_cell.va ngspice/sky130_fd_pr_reram__reram_cell.va
patch "ngspice/sky130_fd_pr_reram__reram_cell.va" < "ngspice/va_model_patch"

# Update spice netlist according to env
sed -i "s|/root/.volare/volare/sky130/versions|$PDK_ROOT|g" ngspice/reram_example.spice

# Compile model
"$SCRIPT_DIR/openvaf" $SCRIPT_DIR/ngspice/sky130_fd_pr_reram__reram_cell.va

# Copy model and example netlist
